import getTableNameForSandbox from "./_get-table-name-sandbox";

import getTableNameForArc6 from "./_get-table-name-ssm";

import olds from "./_get-table-name-old";

function _getTableName(callback) {
